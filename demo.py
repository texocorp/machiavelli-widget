...
# 実運用では news_fetcher.py が RSS から実際の記事URLを自動取得します。
SAMPLE_NEWS = [
    NewsItem(
        ...
        source="国内政治/外交報道",
        url="https://example.com/news/takaichi-taiwan-remark",
    ),
    NewsItem(
        ...
        source="Bloomberg",
        url="https://example.com/news/china-military-buildup-taiwan",
    ),
    NewsItem(
        ...
        source="Bloomberg",
        url="https://example.com/news/us-taiwan-relations-strain",
    ),
    NewsItem(
        ...
        url="https://example.com/news/trump-tariff-policy-2026",
    ),
    NewsItem(
