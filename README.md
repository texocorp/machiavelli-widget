...
3. 以下を貼り付け、`FEED_URL` の部分を手順2で控えたURLに書き換える

```html
<div id="machiavelli-tweets"></div>
<link rel="stylesheet" href="FEED_URL/widget.css">
<script
  src="FEED_URL/widget.js"
  data-feed="FEED_URL/feed.json"
...
例(手順2のURLが `https://gotoh.github.io/machiavelli-widget/` の場合):

```html
<div id="machiavelli-tweets"></div>
<link rel="stylesheet" href="https://gotoh.github.io/machiavelli-widget/widget.css">
<script
  src="https://gotoh.github.io/machiavelli-widget/widget.js"
  data-feed="https://gotoh.github.io/machiavelli-widget/feed.json"
  data-target="machiavelli-tweets"
  data-count="5"
  data-refresh="600000">
</script>
...
4. 「更新」または「公開」を押す
5. ページを表示し、サンプルのつぶやき2件(`docs/feed.json` に同梱)が表示されれば成功です
